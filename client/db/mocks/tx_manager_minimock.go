...
//go:generate minimock -i github.com/ArtEmerged/library/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/ArtEmerged/library/client/db"
...
type TxManagerMock struct {
	...
	funcReadCommitted          func(ctx context.Context, fn mm_db.Handler) (err error)
	inspectFuncReadCommitted   func(ctx context.Context, fn mm_db.Handler)
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Expect(ctx context.Context, fn mm_db.Handler) *mTxManagerMockReadCommitted {
	...
	mmReadCommitted.defaultExpectation.params = &TxManagerMockReadCommittedParams{ctx, fn}
...
// ExpectFnParam2 sets up expected param fn for TxManager.ReadCommitted
func (mmReadCommitted *mTxManagerMockReadCommitted) ExpectFnParam2(fn mm_db.Handler) *mTxManagerMockReadCommitted {
	if mmReadCommitted.mock.funcReadCommitted != nil {
		mmReadCommitted.mock.t.Fatalf("TxManagerMock.ReadCommitted mock is already set by Set")
	}
	...
	mmReadCommitted.defaultExpectation.paramPtrs.fn = &fn

	return mmReadCommitted
}

// Inspect accepts an inspector function that has same arguments as the TxManager.ReadCommitted
func (mmReadCommitted *mTxManagerMockReadCommitted) Inspect(f func(ctx context.Context, fn mm_db.Handler)) *mTxManagerMockReadCommitted {
...
func (mmReadCommitted *mTxManagerMockReadCommitted) Set(f func(ctx context.Context, fn mm_db.Handler) (err error)) *TxManagerMock {
	if mmReadCommitted.defaultExpectation != nil {
...
// Then helper
func (mmReadCommitted *mTxManagerMockReadCommitted) When(ctx context.Context, fn mm_db.Handler) *TxManagerMockReadCommittedExpectation {
	if mmReadCommitted.mock.funcReadCommitted != nil {
		mmReadCommitted.mock.t.Fatalf("TxManagerMock.ReadCommitted mock is already set by Set")
	}
	...
	expectation := &TxManagerMockReadCommittedExpectation{
		...
		params: &TxManagerMockReadCommittedParams{ctx, fn},
	}
...
func (mmReadCommitted *TxManagerMock) ReadCommitted(ctx context.Context, fn mm_db.Handler) (err error) {
	...
	if mmReadCommitted.inspectFuncReadCommitted != nil {
		mmReadCommitted.inspectFuncReadCommitted(ctx, fn)
	}

	mm_params := TxManagerMockReadCommittedParams{ctx, fn}
	...
	if mmReadCommitted.ReadCommittedMock.defaultExpectation != nil {
		...
		mm_got := TxManagerMockReadCommittedParams{ctx, fn}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.fn != nil && !minimock.Equal(*mm_want_ptrs.fn, mm_got.fn) {
				mmReadCommitted.t.Errorf("TxManagerMock.ReadCommitted got unexpected parameter fn, want: %#v, got: %#v%s\n", *mm_want_ptrs.fn, mm_got.fn, minimock.Diff(*mm_want_ptrs.fn, mm_got.fn))
			}
	...
	if mmReadCommitted.funcReadCommitted != nil {
		return mmReadCommitted.funcReadCommitted(ctx, fn)
	}
	mmReadCommitted.t.Fatalf("Unexpected call to TxManagerMock.ReadCommitted. %v %v", ctx, fn)
	return
}
